        ...
        <div id="carouselExampleDark" class="carousel carousel-light slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="<?php echo base_url() ?>assets/img/bg-12.jpg" width="100%" height="320px">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="font-weight-bold">SELAMAT DATANG DI WEBSITE</h5>
                        <p class="text-dark">Aplikasi Pembayaran SPP sekolah SMK Negeri 1 Cijati</p>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="font-weight-bold text-dark">Memudahkan Untuk bertransaksi dengan siswa yang membayar spp.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="<?php echo base_url() ?>assets/img/bg-01.jpg" width="100%" height="320px">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="font-weight-bold text-dark">SMK Negeri 1 Cijati</h5>
                        <p class="font-weight-bold text-dark">Cianjur, provinsi jawa barat</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-gradient- shadow text-center border-radius-md">
                                <img src="<?php echo base_url() ?>assets/img/logo5.jpg" width="60px" height="60px">
                            </div>
                        </div>
                    </div>
                </div>
